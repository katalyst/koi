...
module Koi
  module Tables
    ...
    class HeaderRowComponent < Katalyst::Tables::HeaderRowComponent
      ...
      #  # => <th class="koi--tables-col-s">Active</th>
      #
      ...
      #  # => <th class="koi--tables-col-s">Published on</th>
      #
      ...
      #  # => <th class="koi--tables-col-s">Created at</th>
      #
      ...
      #  # => <th class="koi--tables-col-m">Comment Count</th>
      #
      ...
      #  # => <th class="koi--tables-col-m">Price</th>
      #
      ...
      #  # => <th class="koi--tables-col-l">Content</th>
      #
      ...
      #  # => <th class="koi--tables-col-s">Content</th>
      #
      ...
      #  <% row.image :image %> # => <th>Image</th>
      #
      # @example Render a image column header with a custom label
      #  <% row.image :image, label: "Preview" %> # => <th>Preview</th>
      #
      ...
      #  # => <th class="koi--tables-col-s">Attachment</th>
      #
