...
// $.fn.document ////////////////////////////////////////////////////////////
  ...
  , isEquivalence: function (arg)
    {
      for (var i = 1; i < arg.length; i ++) if (arg [i] !== arg [i - 1]) return false;
      return true;
    }
  ...
  $.fn.extend ({
    ...
    equalizeWindow: function ()
    {
      ...
      return $.isNontrivialEquivalence ($windows)? $windows [0].jQuery (this.toArray ()) : this;
    }
  ...
  , $env: function (k)
    {
      return this.map (function () { return $ (this).env (k) });
    }
  ...
  , envParent: function ()
    {
      ...
      {
        var $this = $ (this);
        return $.isWindow (this) ? ($this.parentFrame () [0] || $this.parentWindow ())
  ...
  , parentWindow: function ()
    {
      var win = $ (this).window (), parent = win.parent;
      return parent === win ? undefined : parent;
    }

  , $parentWindow: function ()
    {
      return this.map (function () { return $ (this).parentWindow (); }).equalizeWindow ();
    }
  ...
  , $parentDocument: function ()
    {
      return this.$parentWindow ().map (function () { return this.document; });
    }
  ...
  , parentFrame: function ()
    {
      ...
      {
        return this.jQuery ('frame, iframe').filter
          (function () { return $ (this).contentWindow () === win; }) [0];
      });
    }
  ...
  , $document: function ()
    {
      return this.map (function ()
      {
        return $.isDocument (this.ownerDocument)? this.ownerDocument
             : $.isDocument (this)?               this
             : $.isWindow (this)?                 this.document
             : undefined
             ;
      });
    }
