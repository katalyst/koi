...
CKEDITOR.editorConfig = function( config ) {
  ...
  config.filebrowserWindowHeight       = 750;
	...
	config.removeButtons = 'Cut,Copy,Styles,Underline,Subscript,Superscript,Strike,Anchor,HorizontalRule,SpecialChar,FontSize,Save,Print,Preview,NewPage,Font,Iframe,PageBreak,Smiley,Flash';
