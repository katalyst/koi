...
describe Koi::Tables::Header do
  ...
  describe Koi::Tables::Header::BooleanComponent do
    it "renders column header" do
      ...
      expect(rendered).to match_html(<<~HTML)
        <th class="koi--tables-col-xs koi--tables-col-boolean">Active</th>
      HTML
    end
    ...
    context "when width is specified" do
      it "renders column header" do
        ...
        rendered  = render_inline(component)
        expect(rendered).to match_html(<<~HTML)
          <th class="koi--tables-col-m koi--tables-col-boolean">Active</th>
        HTML
      end
    end
    ...
    context "when width is set to nil" do
      it "renders column header" do
        ...
        rendered  = render_inline(component)
        expect(rendered).to match_html(<<~HTML)
          <th class="koi--tables-col-boolean">Active</th>
        HTML
      end
    end
    ...
    context "when additional css class is specified" do
      it "renders column header" do
        ...
        rendered  = render_inline(component)
        expect(rendered).to match_html(<<~HTML)
          <th class="koi--tables-col-xs koi--tables-col-boolean custom-class">Active</th>
        HTML
      end
    end
  end
  ...
  describe Koi::Tables::Header::NumberComponent do
    ...
    it "renders column header" do
      ...
      rendered  = render_inline(component)
      expect(rendered).to match_html(<<~HTML)
        <th class="koi--tables-col-xs koi--tables-col-number">Ordinal</th>
      HTML
    end
    ...
    context "with sorting" do
      ...
      it "renders column header" do
        ...
        rendered  = render_inline(component)
        expect(rendered).to match_html(<<~HTML)
          <th data-sort="desc" class="koi--tables-col-xs koi--tables-col-number">
    ...
    context "with custom class and sorting" do
      ...
      it "renders column header" do
        ...
        rendered  = render_inline(component)
        expect(rendered).to match_html(<<~HTML)
          <th data-sort="desc" class="koi--tables-col-xs koi--tables-col-number custom-class">
            <a href="/?sort=ordinal+asc">Ordinal</a>
          </th>
        HTML
      end
