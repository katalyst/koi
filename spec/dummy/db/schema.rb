...
ActiveRecord::Schema[7.0].define(version: 2022_08_29_086001) do
  ...
  create_table "katalyst_navigation_links", force: :cascade do |t|
    ...
    t.index ["menu_id"], name: "index_katalyst_navigation_links_on_menu_id"
  end
  ...
  create_table "katalyst_navigation_menus", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["current_version_id"], name: "index_katalyst_navigation_menus_on_current_version_id"
    t.index ["latest_version_id"], name: "index_katalyst_navigation_menus_on_latest_version_id"
  ...
  add_foreign_key "katalyst_navigation_links", "katalyst_navigation_menus", column: "menu_id"
